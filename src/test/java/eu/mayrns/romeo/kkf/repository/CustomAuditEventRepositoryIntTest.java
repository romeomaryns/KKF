...
import eu.mayrns.romeo.kkf.config.audit.AuditEventConverter;
import eu.mayrns.romeo.kkf.domain.PersistentAuditEvent;
...
import static eu.mayrns.romeo.kkf.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
