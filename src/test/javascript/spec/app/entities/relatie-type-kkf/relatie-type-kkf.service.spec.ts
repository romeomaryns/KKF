...
describe('Service Tests', () => {
    ...
    describe('RelatieTypeKkf Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(RelatieTypeKkfService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/relatie-types';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return RelatieTypeKkf', () => {
