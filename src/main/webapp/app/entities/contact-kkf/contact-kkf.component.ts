...
@Component({
    selector: 'jhi-contact-kkf',
    templateUrl: './contact-kkf.component.html'
})
export class ContactKkfComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.contactService.search({
                ...
                (res: HttpResponse<ContactKkf[]>) => this.onSuccess(res.body, res.headers),
    ...
    trackId(index: number, item: ContactKkf) {
        return item.id;
    }
