...
@Injectable()
export class ContactKkfPopupService {
            ...
            if (id) {
                this.contactService.find(id)
                    .subscribe((contactResponse: HttpResponse<ContactKkf>) => {
                        const contact: ContactKkf = contactResponse.body;
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.contactModalRef(component, new ContactKkf());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    contactModalRef(component: Component, contact: ContactKkf): NgbModalRef {
